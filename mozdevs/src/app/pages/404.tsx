    ...
    <div className="max-w-[50rem] flex flex-col mx-auto size-full">
      ...
      <header className="mb-auto flex justify-center z-50 w-full py-4">
        <nav className="px-4 sm:px-6 lg:px-8">
          <a
            className="flex-none text-xl text-black font-semibold sm:text-3xl dark:text-white"
            href="#"
            aria-label="Brand"
          >
            Brand
      ...
      <main id="content">
        <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
          <h1 className="block text-7xl text-black font-bold text-gray-800 sm:text-9xl ">
            404
          </h1>
          <p className="mt-3 text-gray-600 text-black dark:text-neutral-400">
